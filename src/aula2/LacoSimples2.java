...
public class LacoSimples2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digiti 1 para verificar sua persistência ou 2 para sair: ");
		opcao = ler.nextInt();

		switch (opcao) {
		case 1:
			System.out.println("Se vc estiver tendo persistência digite -true caso não esteja digite false:");
